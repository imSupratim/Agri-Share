...
const Login = () => {
  ...
  return (
    <div className="flex">
      ...
      <div className="flex-1 flex flex-col justify-center px-10 md:mt-15">
        <div ref={titleRef} className="mb-8">
          <h1 className="text-4xl flex gap-2 items-center justify-center font-bold text-green-700">
            Login <div className="bg-yellow-400 rounded-full p-2 "><Sprout className="size-10"/></div>
          </h1>
        </div>
      ...
      <div ref={imageRef} className="hidden md:flex flex-1 justify-center items-center mt-10">
        <LoginDesign />
      </div>
    </div>
  );
